...
eventdate[condition == "placebo"] <- index_date[condition == "placebo"] + rexp(n = placebo_n,
                                                       rate = 1 / tte_placebo) * 365

eventdate[condition == "drug"] <- index_date[condition == "drug"] + rexp(n = drug_n,
                                                       rate = 1 / tte_drug) * 365

...
#' @param follow_up_date character. The name of a column in cohort indicating follow up dates.
#' @param follow_up_time_rename character. (Optional) Name of the resulting follow up days column.
#'
#' @return dataframe.
#' @export
#'
